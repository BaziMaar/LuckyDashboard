        ...
        { field: 'updatedAt', headerName: 'Updated At', width: 200 },
        {
          ...
          renderCell: (params) => (
            <Button
              variant="contained"
              size="small"
              onClick={() => handlePayment(params.row.phone, params.row.amount, 1, params.row._id)}
              disabled={isButtonDisabled || params.row.transactionUpdated === 1}
            >
              Accept
            </Button>
          ),
        },
        {
          ...
          renderCell: (params) => (
            <Button
              variant="contained"
              size="small"
              onClick={() => handlePayment(params.row.phone, params.row.amount, 2, params.row._id)}
              disabled={isButtonDisabled || params.row.transactionUpdated === 1}
            >
              Reject
            </Button>
